...
#'
#' Define access scopes for an application. See \url{https://developer.typeform.com/get-started/scopes/}
...
#' Set option for rtypeform client id
#'
#' @importFrom assertthat assert_that
...
#' Set option for rtypeform client secret
#'
#' @importFrom assertthat assert_that
...
#' Set the environment variable with access token
#'
#' @export
#' @param token Either a string of a personal access token, or an OAuth token returned by make_new_token
