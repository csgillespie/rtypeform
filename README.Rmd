...
**This README relates to version 1.0.0 that is NOT on CRAN. This is a breaking version
as it transfers from V1 to V2 to the typeform API. Feel free to try it out
and give feedback.**
